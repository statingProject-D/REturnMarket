    ...
    <div class="screenForm">
      <main class="main">
        <div class="fix-header">
          <span class="fix-header__subtitle">상품등록</span>
          <a href="#" class="backBtn" onclick="history.back(-1);"><i class="fas fa-times"></i></a>
        </div>

        <form action="pdUploadAction.pd" class="writeForm" method="post" enctype="multipart/form-data">
          <label for="pdName">* 상품명</label>
          <input type="text" class="form-control" id="pdName" name="pdName" placeholder="최대30자리까지 입력 가능!" maxlength="30" required>
          ...
          <input type="number" class="form-control" id="pdCount" name="pdCount" min="1" max="999" required>
          
          <label for="pdInfo">* 상품 설명</label>
          <textarea name="pdInfo" id="summernote" required></textarea>
          ...
          <div class="auction-container form-horizontal">
            ...
            <table class="table">
              <tr class="form-group__auction">
                ...
                <td class="col-8"><input type="number" class="form-control" min="0" id="startPrice" class="start__cost" name="auStartPrice"></td>
                <td class="col-1">원</td>
              </tr>
              ...
              <tr class="form-group__auction">
                ...
                <td class="col-8"><input type="number" class="form-control" min="0" id="start-cost" class="auDirectPrice" name="auDirectPrice" required></td>
                <td class="col-1">원</td>
              </tr>
            </table>
