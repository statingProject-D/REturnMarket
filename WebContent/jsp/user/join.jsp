  ...
  <div class="screen">
    <div class="screenForm">
      <main class="main">
        ...
        <form action="joinUser.us" method="post" name="joinForm" class="joinForm"> <!-- onsubmit = submit할때 리턴이 true 일때만 실행 -->
          ...
          <table class="table table-hover">
            <tr>
              ...
              <td class="td-right">
                <div class="id-form">
                  <input type="text" class="form-control id-input" id="user_id" name="user_id" placeholder="id는 최소 6자리 입니다." pattern="[A-Za-z0-9]{6,20}" required><input type="button" value="중복확인" required class="idChkBtn" onclick="window.open('jsp/user/idChk.jsp?openInit=true','','width=300,height=200')" />
                </div>
              </td>
            </tr>
            <tr>
              ...
              <td class="td-right">
                <input type="password" class="form-control pw" id="pw" name="pw" placeholder="영문,숫자,특수문자 포함 8자리 이상" pattern="^(?=.*[A-Za-z])(?=.*\d)(?=.*[$@$!%*#?&])[A-Za-z\d$@$!%*#?&]{8,}$" required>
              </td>
            </tr>
            <tr>
              <td class="td-left">
              ...
              <td class="td-right">
                <input type="password" class="form-control rePw" id="rePw" name="rePw" placeholder="영문,숫자,특수문자 포함 8자리 이상" pattern="^(?=.*[A-Za-z])(?=.*\d)(?=.*[$@$!%*#?&])[A-Za-z\d$@$!%*#?&]{8,}$" required>
              </td>
            </tr>
            <tr>
              <td class="td-left">
            ...
            <tr>
              ...
              <td class="td-right">
                <div class="addr-inline__group">
                  <input type="text" id="sample4_postcode" class="addressNum" name="addrNum" placeholder="우편번호" required>
                  <input type="button" class="addressBtn" onclick="sample4_execDaumPostcode()" value="우편번호 찾기"><br>
                </div>
                <input type="text" class="roadAddress" name="addr1" id="sample4_roadAddress" placeholder="도로명주소" required>
                <input type="text" class="detailAddress" name="addr2" id="sample4_detailAddress" placeholder="상세주소" required>
              </td>
            </tr>
          </table>
          ...
          <div colspan="2" class="btn-box">
            <!-- email에서 확인하는거 필요함 -->
            <input type="submit" class="btn createId" value="계정 생성">
